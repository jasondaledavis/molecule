        ...
        public function render () {
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $slides as $slide ) {
                    ...
                    echo '<img class="redux-slides-image" id="image_image_id_' . $x . '" src="' . $slide[ 'thumb' ] . '" alt="Louisville Web Design" target="_blank" rel="external" />';
                    echo '</a>';
                    echo '</div>';
            ...
            if ( $x == 0 ) {
                ...
                echo '<img class="redux-slides-image" id="image_image_id_' . $x . '" src="" alt="Louisville Web Design" target="_blank" rel="external" />';
                echo '</a>';
                echo '</div>';
