=== Molecule ===
Contributors: Element 502, Jason Davis
...
For more information about Molecule's base files please go to https://codex.wordpress.org/Twenty_Sixteen.
...
For base files: https://codex.wordpress.org/Twenty_Sixteen_Theme_Changelog#Version_1.3
...
Revised <head> tag to match Twenty Sixteen with Mocule custom text domain.
