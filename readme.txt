...
= 2.2.1 =
* recoded CSS for better UX for customizations
* updated meta details in header and in blog for depricated author function
* removed stray CSS code not required.
...
= 2.5.1 = 
* updated hooks in archive-products.php for new hook placement
