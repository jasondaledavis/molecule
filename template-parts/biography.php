...
<div class="author-info">
	<div class="author-avatar">
		<?php
		/**
		 * Filter the Woody author bio avatar size.
		 *
		 * @since Woody 1.0
		 *
		 * @param int $size The avatar height and width size in pixels.
		 */
		$author_bio_avatar_size = apply_filters( 'woody_author_bio_avatar_size', 80 );
	...
	<div class="author-description">
		...
		<p class="author-bio">
			...
			<a class="author-link url fn n" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author">
				<?php printf( __( 'View all posts by %s', 'woody' ), get_the_author() ); ?>
			</a>
		</p><!-- .author-bio -->
